...
class Subscriptions2 extends StatefulWidget {
  const Subscriptions2({super.key});

  @override
  State<Subscriptions2> createState() => _Subscriptions2State();
}

class _Subscriptions2State extends State<Subscriptions2> {
